...
namespace Eumis.Public.Domain.Entities.Umis.SapInterfaces
{
    ...
    {
        public static IList<SapPaymentType> PaidAmountTypes = new List<SapPaymentType>
        {
        ...
        public static IList<SapPaymentType> ReimbursementTypes = new List<SapPaymentType>
        {
        ...
        public SapPaidAmountFinanceSource? FinanceSource { get; set; }
