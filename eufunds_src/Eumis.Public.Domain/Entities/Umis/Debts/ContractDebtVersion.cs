...
namespace Eumis.Public.Domain.Entities.Umis.Debts
{
    public partial class ContractDebtVersion : IAggregateRoot
    {
        ...
        {
            this.ContractDebtVersionPayments = new List<ContractDebtVersionPayment>();
        }

        public ContractDebtVersion(int contractDebtId, int createdByUserId) : this()
        {
            ...
            : this()
        {
            ...
            foreach (var paymentRequests in previousVersion.ContractDebtVersionPayments)
            {
                this.ContractDebtVersionPayments.Add(
                    new ContractDebtVersionPayment(paymentRequests.ContractReportPaymentId));
            }
        ...
        public ICollection<ContractDebtVersionPayment> ContractDebtVersionPayments { get; set; }
    }
