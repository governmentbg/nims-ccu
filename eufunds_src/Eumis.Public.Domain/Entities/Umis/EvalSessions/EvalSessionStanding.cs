...
namespace Eumis.Public.Domain.Entities.Umis.EvalSessions
{
    public class EvalSessionStanding
    {
        ...
        {
            this.EvalSessionStandingProjects = new List<EvalSessionStandingProject>();
        }
        ...
        public virtual ICollection<EvalSessionStandingProject> EvalSessionStandingProjects { get; set; }
    }
