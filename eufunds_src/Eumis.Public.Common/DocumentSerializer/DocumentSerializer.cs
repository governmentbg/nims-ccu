...
namespace Eumis.Public.Common
{
    ...
    public class DocumentSerializer : IDocumentSerializer
    {
        ...
        {
            return this.XmlSerializeToStringInternal(typeof(T), document);
        }
        ...
        {
            return this.XmlSerializeToStringInternal(document.GetType(), document);
        }
        ...
        {
            return this.XmlSerializeToBytesInternal(typeof(T), document);
        }
        ...
        {
            return this.XmlSerializeToBytesInternal(document.GetType(), document);
        }
        ...
        public T XmlDeserializeFromString<T>(string documentXml)
        {
            ...
            return (T)this.XmlDeserializeFromStringInternal(typeof(T), documentXml);
        }
        ...
        {
            return this.XmlDeserializeFromStringInternal(objectType, documentXml);
        }
        ...
        {
            return (T)this.XmlDeserializeFromBytesInternal(typeof(T), bytes);
        }
        ...
        {
            return this.XmlDeserializeFromBytesInternal(objectType, bytes);
        }
        ...
        {
            byte[] bytes = this.XmlSerializeToBytesInternal(type, document);
