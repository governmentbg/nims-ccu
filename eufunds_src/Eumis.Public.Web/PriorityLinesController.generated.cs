...
{
    public partial class PriorityLinesController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected PriorityLinesController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public PriorityLinesController Actions { get { return MVC.PriorityLines; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "PriorityLines";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "PriorityLines";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Views/PriorityLines/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PriorityLinesController : Eumis.Public.Web.Controllers.PriorityLinesController
    {
        public T4MVC_PriorityLinesController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void GetBudgetPieDataOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult GetBudgetPieData()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.GetBudgetPieData);
            GetBudgetPieDataOverride(callInfo);
            return callInfo;
        }

        [NonAction]
        partial void GetBudgetChartDataOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult GetBudgetChartData()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.GetBudgetChartData);
            GetBudgetChartDataOverride(callInfo);
            return callInfo;
        }
