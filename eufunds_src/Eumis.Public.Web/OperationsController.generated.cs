...
namespace Eumis.Public.Web.Controllers
{
    public partial class OperationsController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Views/Operations/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_OperationsController : Eumis.Public.Web.Controllers.OperationsController
    {
        ...
        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Eumis.Public.Web.Models.Operations.OperationsSearchVM vm);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(Eumis.Public.Web.Models.Operations.OperationsSearchVM vm)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
