...
namespace Eumis.Public.Web.Controllers
{
    public partial class PartnerController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public PartnerController Actions { get { return MVC.Partner; } }
        ...
        {
            public readonly string partner = "partner";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Views/Partner/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PartnerController : Eumis.Public.Web.Controllers.PartnerController
    {
        public T4MVC_PartnerController() : base(Dummy.Instance) { }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string partner, string companyType, string companyLegalType, string companyUin, bool showRes, string page);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(string partner, string companyType, string companyLegalType, string companyUin, bool showRes, string page)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "partner", partner);
            ...
            IndexOverride(callInfo, partner, companyType, companyLegalType, companyUin, showRes, page);
            return callInfo;
        }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Eumis.Public.Web.Models.Partner.PartnerSearchVM vm);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(Eumis.Public.Web.Models.Partner.PartnerSearchVM vm)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
