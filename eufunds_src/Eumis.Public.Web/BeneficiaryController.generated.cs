...
{
    public partial class BeneficiaryController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected BeneficiaryController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public BeneficiaryController Actions { get { return MVC.Beneficiary; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Beneficiary";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Beneficiary";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Views/Beneficiary/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_BeneficiaryController : Eumis.Public.Web.Controllers.BeneficiaryController
    {
        public T4MVC_BeneficiaryController() : base(Dummy.Instance) { }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string beneficiary, string companyType, string companyLegalType, string companyUin, bool showRes, string page);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(string beneficiary, string companyType, string companyLegalType, string companyUin, bool showRes, string page)
        {
            ...
            IndexOverride(callInfo, beneficiary, companyType, companyLegalType, companyUin, showRes, page);
            return callInfo;
        }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Eumis.Public.Web.Models.Beneficiary.BeneficiarySearchVM vm);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(Eumis.Public.Web.Models.Beneficiary.BeneficiarySearchVM vm)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
