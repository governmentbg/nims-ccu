...
{
    public partial class SubcontractorController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected SubcontractorController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public SubcontractorController Actions { get { return MVC.Subcontractor; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Subcontractor";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Subcontractor";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        {
            public readonly string subcontractor = "subcontractor";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Views/Subcontractor/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_SubcontractorController : Eumis.Public.Web.Controllers.SubcontractorController
    {
        public T4MVC_SubcontractorController() : base(Dummy.Instance) { }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string subcontractor, string companyUin, bool showRes, string page);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(string subcontractor, string companyUin, bool showRes, string page)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "subcontractor", subcontractor);
            ...
            IndexOverride(callInfo, subcontractor, companyUin, showRes, page);
            return callInfo;
        }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Eumis.Public.Web.Models.Subcontractor.SubcontractorSearchVM vm);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(Eumis.Public.Web.Models.Subcontractor.SubcontractorSearchVM vm)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
