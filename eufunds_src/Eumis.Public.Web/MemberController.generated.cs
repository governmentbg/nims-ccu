...
namespace Eumis.Public.Web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_MemberController : Eumis.Public.Web.Controllers.MemberController
    {
        public T4MVC_MemberController() : base(Dummy.Instance) { }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string member, string companyUin, bool showRes, string page);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(string member, string companyUin, bool showRes, string page)
        {
            ...
            IndexOverride(callInfo, member, companyUin, showRes, page);
            return callInfo;
        }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Eumis.Public.Web.Models.Member.MemberSearchVM vm);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(Eumis.Public.Web.Models.Member.MemberSearchVM vm)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
