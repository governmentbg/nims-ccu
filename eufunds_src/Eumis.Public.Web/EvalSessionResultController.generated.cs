...
{
    public partial class EvalSessionResultController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected EvalSessionResultController(Dummy d) { }
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.JsonResult GetResultType()
        {
            return new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.GetResultType);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.JsonResult GetResultTypes()
        {
            return new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.GetResultTypes);
        }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public EvalSessionResultController Actions { get { return MVC.EvalSessionResult; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "EvalSessionResult";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "EvalSessionResult";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string GetResultType = "GetResultType";
            public readonly string GetResultTypes = "GetResultTypes";
        ...
        public class ActionNameConstants
        {
            ...
            public const string GetResultType = "GetResultType";
            public const string GetResultTypes = "GetResultTypes";
        ...
        static readonly ActionParamsClass_GetResultType s_params_GetResultType = new ActionParamsClass_GetResultType();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_GetResultType GetResultTypeParams { get { return s_params_GetResultType; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_GetResultType
        {
            public readonly string id = "id";
        }
        static readonly ActionParamsClass_GetResultTypes s_params_GetResultTypes = new ActionParamsClass_GetResultTypes();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_GetResultTypes GetResultTypesParams { get { return s_params_GetResultTypes; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_GetResultTypes
        {
            public readonly string term = "term";
            public readonly string parentId = "parentId";
        }
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string AdminAdmiss = "AdminAdmiss";
                public readonly string Index = "Index";
                public readonly string Preliminary = "Preliminary";
                public readonly string Standing = "Standing";
            }
            public readonly string AdminAdmiss = "~/Views/EvalSessionResult/AdminAdmiss.cshtml";
            public readonly string Index = "~/Views/EvalSessionResult/Index.cshtml";
            public readonly string Preliminary = "~/Views/EvalSessionResult/Preliminary.cshtml";
            public readonly string Standing = "~/Views/EvalSessionResult/Standing.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_EvalSessionResultController : Eumis.Public.Web.Controllers.EvalSessionResultController
    {
        public T4MVC_EvalSessionResultController() : base(Dummy.Instance) { }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string programmeId, string procedureId, string resultType, bool showRes, string page);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(string programmeId, string procedureId, string resultType, bool showRes, string page)
        {
            ...
            IndexOverride(callInfo, programmeId, procedureId, resultType, showRes, page);
            return callInfo;
        }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Eumis.Public.Web.Models.EvalSessionResult.EvalSessionResultSearchVM vm);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(Eumis.Public.Web.Models.EvalSessionResult.EvalSessionResultSearchVM vm)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
        ...
        [NonAction]
        partial void ShowOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string resultId, string resultType, string page);

        [NonAction]
        public override System.Web.Mvc.ActionResult Show(string resultId, string resultType, string page)
        {
            ...
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "resultType", resultType);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "page", page);
            ShowOverride(callInfo, resultId, resultType, page);
            return callInfo;
        }
        ...
        [NonAction]
        partial void GetResultTypeOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, Eumis.Public.Domain.Entities.Umis.EvalSessions.EvalSessionResultType id);

        [NonAction]
        public override System.Web.Mvc.JsonResult GetResultType(Eumis.Public.Domain.Entities.Umis.EvalSessions.EvalSessionResultType id)
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.GetResultType);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
            GetResultTypeOverride(callInfo, id);
            return callInfo;
        }

        [NonAction]
        partial void GetResultTypesOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, string term, string parentId);

        [NonAction]
        public override System.Web.Mvc.JsonResult GetResultTypes(string term, string parentId)
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.GetResultTypes);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "term", term);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "parentId", parentId);
            GetResultTypesOverride(callInfo, term, parentId);
            return callInfo;
        }
