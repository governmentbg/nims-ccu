...
{
    public partial class Operations508Controller
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected Operations508Controller(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public Operations508Controller Actions { get { return MVC.Operations508; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Operations508";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Operations508";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Views/Operations508/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_Operations508Controller : Eumis.Public.Web.Controllers.Operations508Controller
    {
        public T4MVC_Operations508Controller() : base(Dummy.Instance) { }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string programmeId, string dateFrom, string dateTo, bool showRes, string page);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(string programmeId, string dateFrom, string dateTo, bool showRes, string page)
        {
            ...
            IndexOverride(callInfo, programmeId, dateFrom, dateTo, showRes, page);
            return callInfo;
        }
