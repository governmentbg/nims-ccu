...
namespace Eumis.Public.Web.Controllers
{
    public partial class EventsController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Views/Events/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_EventsController : Eumis.Public.Web.Controllers.EventsController
    {
        public T4MVC_EventsController() : base(Dummy.Instance) { }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string date);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(string date)
        {
