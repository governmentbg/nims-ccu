...
{
    public class BFPContractContractTeam : CSValidatorBase<R_10039.BFPContractContractTeam>
    {
        protected override void Validate(ICSValidationEngine csValidationEngine, R_10039.BFPContractContractTeam complexType, string modelPath, IList<ValidationOption> errors)
        {
            ...
            //}
            //else if (complexType.Name.Length > Constants.ContractTeamNameLength)
            //{
            //    errors.Add(ValidationOption.Create(
            //                            modelPath + ".Name",
            ...
            if (string.IsNullOrWhiteSpace(complexType.Position))
            {
                errors.Add(ValidationOption.Create(
                                        modelPath + ".Position",
                                        Global.ShortTemplateRequired,
                                        string.Format(Global.ViewTemplateRequired, Global.BFPProjectPosition, Global.SectionTeam), true, true));
            ...
            else if (complexType.Position.Length > Constants.ContractTeamPositionLength)
            {
                errors.Add(ValidationOption.Create(
                                        ...
                                        string.Format(Global.ViewTemplateSymbolsMax, Global.BFPProjectPosition, Global.SectionTeam, Constants.ContractTeamPositionLength), true, true));
            ...
            //}
            //else if (complexType.Phone.Length > Constants.ContractTeamPhoneLength)
            //{
            //    errors.Add(ValidationOption.Create(
            //                            modelPath + ".Phone",
