...
namespace R_10007
{
	...
	{
		public const string SchemaVersion = "http://ereg.egov.bg/segment/R-10007";
	}




	[XmlType(TypeName="ProgrammeDetailsExpenseBudget",Namespace=Declarations.SchemaVersion),Serializable]
