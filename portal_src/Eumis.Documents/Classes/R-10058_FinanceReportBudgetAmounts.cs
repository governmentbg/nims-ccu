...
namespace R_10058
{
	...
	{
		public const string SchemaVersion = "http://ereg.egov.bg/segment/R-10058";
	}




	[XmlType(TypeName="FinanceReportBudgetAmounts",Namespace=Declarations.SchemaVersion),Serializable]
