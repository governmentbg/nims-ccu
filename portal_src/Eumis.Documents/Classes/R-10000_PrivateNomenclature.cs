...
namespace R_10000
{
	...
	{
		public const string SchemaVersion = "http://ereg.egov.bg/segment/R-10000";
	}




	[XmlType(TypeName="PrivateNomenclature",Namespace=Declarations.SchemaVersion),Serializable]
