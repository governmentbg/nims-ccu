...
namespace R_10067
{
	...
	{
		public const string SchemaVersion = "http://ereg.egov.bg/segment/R-10067";
	}




	[XmlType(TypeName="FinanceSourceReportAmounts",Namespace=Declarations.SchemaVersion),Serializable]
