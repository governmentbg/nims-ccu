...
namespace R_10034
{
	...
	[XmlType(TypeName="BFPContractProgrammeExpenseBudget",Namespace=Declarations.SchemaVersion),Serializable]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	public partial class BFPContractProgrammeExpenseBudget
	{
		...
		[System.Web.Script.Serialization.ScriptIgnore]
        [Newtonsoft.Json.JsonIgnore]
		[XmlElement(Type=typeof(R_10033.BFPContractProgrammeDetailsExpenseBudget),ElementName="BFPContractProgrammeDetailsExpenseBudget",IsNullable=false,Form=XmlSchemaForm.Qualified,Namespace=Declarations.SchemaVersion)]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
