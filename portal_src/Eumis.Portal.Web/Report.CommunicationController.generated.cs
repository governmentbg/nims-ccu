...
namespace Eumis.Portal.Web.Areas.Report.Controllers
{
    public partial class CommunicationController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public CommunicationController Actions { get { return MVC.Report.Communication; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Display = "~/Areas/Report/Views/Communication/Display.cshtml";
            public readonly string Index = "~/Areas/Report/Views/Communication/Index.cshtml";
            public readonly string Prepare = "~/Areas/Report/Views/Communication/Prepare.cshtml";
            public readonly string Preview = "~/Areas/Report/Views/Communication/Preview.cshtml";
            public readonly string Print = "~/Areas/Report/Views/Communication/Print.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CommunicationController : Eumis.Portal.Web.Areas.Report.Controllers.CommunicationController
    {
        public T4MVC_CommunicationController() : base(Dummy.Instance) { }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, R_09987.CommunicationTypeNomenclature type, int page);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(R_09987.CommunicationTypeNomenclature type, int page)
        {
        ...
        [NonAction]
        partial void NewOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, R_09987.CommunicationTypeNomenclature type);

        [NonAction]
        public override System.Web.Mvc.ActionResult New(R_09987.CommunicationTypeNomenclature type)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.New);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "type", type);
            NewOverride(callInfo, type);
            return callInfo;
        }

        [NonAction]
        partial void DeleteOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, System.Guid gid, R_09987.CommunicationTypeNomenclature type);

        [NonAction]
        public override System.Web.Mvc.ActionResult Delete(System.Guid gid, R_09987.CommunicationTypeNomenclature type)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Delete);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "gid", gid);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "type", type);
            DeleteOverride(callInfo, gid, type);
            return callInfo;
        }

        [NonAction]
        partial void PrepareOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Eumis.Portal.Web.Models.Communication.EditVM vm);

        [NonAction]
        public override System.Web.Mvc.ActionResult Prepare(Eumis.Portal.Web.Models.Communication.EditVM vm)
        {
        ...
        [NonAction]
        partial void SaveOverride(T4MVC_System_Web_Mvc_ContentResult callInfo, Eumis.Portal.Web.Models.Communication.EditVM model);

        [NonAction]
        public override System.Web.Mvc.ContentResult Save(Eumis.Portal.Web.Models.Communication.EditVM model)
        {
