...
namespace Eumis.Portal.Web.Controllers
{
    public partial class AccountController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string ProfileEdit = "~/Views/Account/ProfileEdit.cshtml";
            public readonly string Register = "~/Views/Account/Register.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountController : Eumis.Portal.Web.Controllers.AccountController
    {
        ...
        [NonAction]
        partial void RegisterOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Eumis.Portal.Web.Models.Account.RegisterVM vm, bool? captchaValid);

        [NonAction]
        public override System.Web.Mvc.ActionResult Register(Eumis.Portal.Web.Models.Account.RegisterVM vm, bool? captchaValid)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Register);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "vm", vm);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "captchaValid", captchaValid);
            RegisterOverride(callInfo, vm, captchaValid);
            return callInfo;
        }
