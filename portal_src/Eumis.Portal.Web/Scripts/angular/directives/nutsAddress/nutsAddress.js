(function (angular) {
    ...
    angular.module('scaffolding').directive('nutsAddress', ['$window', function ($window) {
        return {
            restrict: 'E',
            scope: {
                model: '=ngModel',
            ...
            templateUrl: '/Scripts/angular/directives/nutsAddress/nutsAddress.html',
                    ...
                    scope.items.forEach(function (val) {
                        if (val[propertyName] != null &&
                            ...
                            nutsAddresses.push({
                                ...
                                FullPathNameEN: val[propertyName].FullPathNameEN
                            });
                        }
                    });
