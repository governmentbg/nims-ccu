...
namespace Eumis.Portal.Web.Areas.Private.Controllers
{
    public partial class OffersController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public OffersController Actions { get { return MVC.Private.Offers; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Preview = "~/Areas/Private/Views/Offers/Preview.cshtml";
            public readonly string Print = "~/Areas/Private/Views/Offers/Print.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_OffersController : Eumis.Portal.Web.Areas.Private.Controllers.OffersController
    {
        ...
        [NonAction]
        partial void PrepareOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Eumis.Portal.Web.Models.Procurements.EditVM model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Prepare(Eumis.Portal.Web.Models.Procurements.EditVM model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Prepare);
