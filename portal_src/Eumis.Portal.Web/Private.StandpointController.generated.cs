...
{
    public partial class StandpointController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected StandpointController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public StandpointController Actions { get { return MVC.Private.Standpoint; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Private";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Standpoint";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Standpoint";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Display = "~/Areas/Private/Views/Standpoint/Display.cshtml";
            public readonly string Prepare = "~/Areas/Private/Views/Standpoint/Prepare.cshtml";
            public readonly string Preview = "~/Areas/Private/Views/Standpoint/Preview.cshtml";
            public readonly string Print = "~/Areas/Private/Views/Standpoint/Print.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_StandpointController : Eumis.Portal.Web.Areas.Private.Controllers.StandpointController
    {
        public T4MVC_StandpointController() : base(Dummy.Instance) { }

        [NonAction]
        partial void PrepareOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Eumis.Portal.Web.Models.Standpoint.EditVM vm);

        [NonAction]
        public override System.Web.Mvc.ActionResult Prepare(Eumis.Portal.Web.Models.Standpoint.EditVM vm)
        {
        ...
        [NonAction]
        partial void SaveOverride(T4MVC_System_Web_Mvc_ContentResult callInfo, Eumis.Portal.Web.Models.Standpoint.EditVM model);

        [NonAction]
        public override System.Web.Mvc.ContentResult Save(Eumis.Portal.Web.Models.Standpoint.EditVM model)
        {
