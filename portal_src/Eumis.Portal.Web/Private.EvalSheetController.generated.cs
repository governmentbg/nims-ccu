...
{
    public partial class EvalSheetController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected EvalSheetController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public EvalSheetController Actions { get { return MVC.Private.EvalSheet; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Private";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "EvalSheet";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "EvalSheet";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Display = "~/Areas/Private/Views/EvalSheet/Display.cshtml";
            public readonly string Prepare = "~/Areas/Private/Views/EvalSheet/Prepare.cshtml";
            public readonly string Preview = "~/Areas/Private/Views/EvalSheet/Preview.cshtml";
            public readonly string Print = "~/Areas/Private/Views/EvalSheet/Print.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_EvalSheetController : Eumis.Portal.Web.Areas.Private.Controllers.EvalSheetController
    {
        public T4MVC_EvalSheetController() : base(Dummy.Instance) { }

        [NonAction]
        partial void PrepareOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Eumis.Portal.Web.Models.EvalSheet.EditVM vm);

        [NonAction]
        public override System.Web.Mvc.ActionResult Prepare(Eumis.Portal.Web.Models.EvalSheet.EditVM vm)
        {
        ...
        [NonAction]
        partial void PauseOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult Pause()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Pause);
            PauseOverride(callInfo);
            return callInfo;
        }
        ...
        [NonAction]
        partial void SaveOverride(T4MVC_System_Web_Mvc_ContentResult callInfo, Eumis.Portal.Web.Models.EvalSheet.EditVM model);

        [NonAction]
        public override System.Web.Mvc.ContentResult Save(Eumis.Portal.Web.Models.EvalSheet.EditVM model)
        {
