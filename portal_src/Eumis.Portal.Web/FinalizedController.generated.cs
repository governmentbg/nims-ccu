...
{
    public partial class FinalizedController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected FinalizedController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public FinalizedController Actions { get { return MVC.Finalized; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Finalized";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Finalized";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Views/Finalized/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_FinalizedController : Eumis.Portal.Web.Controllers.FinalizedController
    {
        public T4MVC_FinalizedController() : base(Dummy.Instance) { }
