...
{
    public partial class BFPContractController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected BFPContractController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public BFPContractController Actions { get { return MVC.Report.BFPContract; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Report";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "BFPContract";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "BFPContract";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        {
            public readonly string cpage = "cpage";
            public readonly string ppage = "ppage";
            public readonly string spage = "spage";
            public readonly string opage = "opage";
        }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Areas/Report/Views/BFPContract/Index.cshtml";
            public readonly string Preview = "~/Areas/Report/Views/BFPContract/Preview.cshtml";
            public readonly string Print = "~/Areas/Report/Views/BFPContract/Print.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_BFPContractController : Eumis.Portal.Web.Areas.Report.Controllers.BFPContractController
    {
        public T4MVC_BFPContractController() : base(Dummy.Instance) { }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int cpage, int ppage, int spage, int opage);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(int cpage, int ppage, int spage, int opage)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "cpage", cpage);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "ppage", ppage);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "spage", spage);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "opage", opage);
            IndexOverride(callInfo, cpage, ppage, spage, opage);
            return callInfo;
        }
        ...
        [NonAction]
        partial void PrepareOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Eumis.Portal.Web.Models.BFPContract.EditVM model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Prepare(Eumis.Portal.Web.Models.BFPContract.EditVM model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Prepare);
        ...
        [NonAction]
        partial void SaveOverride(T4MVC_System_Web_Mvc_ContentResult callInfo, Eumis.Portal.Web.Models.BFPContract.EditVM model);

        [NonAction]
        public override System.Web.Mvc.ContentResult Save(Eumis.Portal.Web.Models.BFPContract.EditVM model)
        {
