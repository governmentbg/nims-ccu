...
namespace Eumis.Portal.Web.Areas.Private.Controllers
{
    public partial class ProjectCommunicationAnswerController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ProjectCommunicationAnswerController Actions { get { return MVC.Private.ProjectCommunicationAnswer; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Display = "~/Areas/Private/Views/ProjectCommunicationAnswer/Display.cshtml";
            public readonly string Prepare = "~/Areas/Private/Views/ProjectCommunicationAnswer/Prepare.cshtml";
            public readonly string Preview = "~/Areas/Private/Views/ProjectCommunicationAnswer/Preview.cshtml";
            public readonly string Print = "~/Areas/Private/Views/ProjectCommunicationAnswer/Print.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ProjectCommunicationAnswerController : Eumis.Portal.Web.Areas.Private.Controllers.ProjectCommunicationAnswerController
    {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, System.Guid communicationGid, System.Guid childGid, string access_token);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(System.Guid communicationGid, System.Guid childGid, string access_token)
        {
            ...
            EditOverride(callInfo, communicationGid, childGid, access_token);
            return callInfo;
        }

        [NonAction]
        partial void PreviewOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, System.Guid communicationGid, System.Guid childGid, string access_token);

        [NonAction]
        public override System.Web.Mvc.ActionResult Preview(System.Guid communicationGid, System.Guid childGid, string access_token)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Preview);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "communicationGid", communicationGid);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "childGid", childGid);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "access_token", access_token);
            PreviewOverride(callInfo, communicationGid, childGid, access_token);
            return callInfo;
        }
