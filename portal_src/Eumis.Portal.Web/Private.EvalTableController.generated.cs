...
{
    public partial class EvalTableController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected EvalTableController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public EvalTableController Actions { get { return MVC.Private.EvalTable; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Private";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "EvalTable";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "EvalTable";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Display = "~/Areas/Private/Views/EvalTable/Display.cshtml";
            public readonly string Prepare = "~/Areas/Private/Views/EvalTable/Prepare.cshtml";
            public readonly string Preview = "~/Areas/Private/Views/EvalTable/Preview.cshtml";
            public readonly string Print = "~/Areas/Private/Views/EvalTable/Print.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_EvalTableController : Eumis.Portal.Web.Areas.Private.Controllers.EvalTableController
    {
        public T4MVC_EvalTableController() : base(Dummy.Instance) { }

        [NonAction]
        partial void PrepareOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Eumis.Portal.Web.Models.EvalTable.EditVM vm);

        [NonAction]
        public override System.Web.Mvc.ActionResult Prepare(Eumis.Portal.Web.Models.EvalTable.EditVM vm)
        {
        ...
        [NonAction]
        partial void SaveOverride(T4MVC_System_Web_Mvc_ContentResult callInfo, Eumis.Portal.Web.Models.EvalTable.EditVM model);

        [NonAction]
        public override System.Web.Mvc.ContentResult Save(Eumis.Portal.Web.Models.EvalTable.EditVM model)
        {
