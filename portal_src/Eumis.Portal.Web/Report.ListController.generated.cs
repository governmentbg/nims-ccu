...
namespace Eumis.Portal.Web.Areas.Report.Controllers
{
    public partial class ListController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ListController Actions { get { return MVC.Report.List; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Report";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "List";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "List";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Areas/Report/Views/List/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ListController : Eumis.Portal.Web.Areas.Report.Controllers.ListController
    {
