...
{
    public partial class FinalizedController : DraftBaseController
    {
        public FinalizedController(IDocumentSerializer documentSerializer, IDraftCommunicator draftCommunicator,
        ...
        [HttpGet]
        public override ActionResult Edit(Guid gid)
        {
            _draftCommunicator.DefinalizeDraft(gid, CurrentUser.AccessToken);

            return base.Edit(gid);
        }
    }
}