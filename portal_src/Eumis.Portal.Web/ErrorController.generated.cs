...
namespace Eumis.Portal.Web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ErrorController : Eumis.Portal.Web.Controllers.ErrorController
    {
        public T4MVC_ErrorController() : base(Dummy.Instance) { }

        [NonAction]
        partial void ShowOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string code, bool? isIisError);

        [NonAction]
        public override System.Web.Mvc.ActionResult Show(string code, bool? isIisError)
        {
            ...
            ShowOverride(callInfo, code, isIisError);
            return callInfo;
        }
