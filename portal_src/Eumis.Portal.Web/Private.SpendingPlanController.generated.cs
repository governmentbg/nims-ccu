...
{
    public partial class SpendingPlanController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected SpendingPlanController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public SpendingPlanController Actions { get { return MVC.Private.SpendingPlan; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Private";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "SpendingPlan";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "SpendingPlan";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Display = "~/Areas/Private/Views/SpendingPlan/Display.cshtml";
            public readonly string Prepare = "~/Areas/Private/Views/SpendingPlan/Prepare.cshtml";
            public readonly string Preview = "~/Areas/Private/Views/SpendingPlan/Preview.cshtml";
            public readonly string Print = "~/Areas/Private/Views/SpendingPlan/Print.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_SpendingPlanController : Eumis.Portal.Web.Areas.Private.Controllers.SpendingPlanController
    {
        public T4MVC_SpendingPlanController() : base(Dummy.Instance) { }

        [NonAction]
        partial void PrepareOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Eumis.Portal.Web.Models.SpendingPlan.EditVM vm);

        [NonAction]
        public override System.Web.Mvc.ActionResult Prepare(Eumis.Portal.Web.Models.SpendingPlan.EditVM vm)
        {
        ...
        [NonAction]
        partial void SaveOverride(T4MVC_System_Web_Mvc_ContentResult callInfo, Eumis.Portal.Web.Models.SpendingPlan.EditVM model);

        [NonAction]
        public override System.Web.Mvc.ContentResult Save(Eumis.Portal.Web.Models.SpendingPlan.EditVM model)
        {
