...
namespace Eumis.Portal.Web.Areas.Private.Controllers
{
    public partial class BFPContractController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public BFPContractController Actions { get { return MVC.Private.BFPContract; } }
        ...
        public class ViewsClass
        {
            ...
            public class _ViewNamesClass
            {
                ...
                public readonly string Preview = "Preview";
                public readonly string Print = "Print";
                public readonly string PrintSAP = "PrintSAP";
                public readonly string SAP = "SAP";
            }
            public readonly string Display = "~/Areas/Private/Views/BFPContract/Display.cshtml";
            public readonly string Prepare = "~/Areas/Private/Views/BFPContract/Prepare.cshtml";
            public readonly string Preview = "~/Areas/Private/Views/BFPContract/Preview.cshtml";
            public readonly string Print = "~/Areas/Private/Views/BFPContract/Print.cshtml";
            public readonly string PrintSAP = "~/Areas/Private/Views/BFPContract/PrintSAP.cshtml";
            public readonly string SAP = "~/Areas/Private/Views/BFPContract/SAP.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_BFPContractController : Eumis.Portal.Web.Areas.Private.Controllers.BFPContractController
    {
        public T4MVC_BFPContractController() : base(Dummy.Instance) { }

        [NonAction]
        partial void PrepareOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Eumis.Portal.Web.Models.BFPContract.EditVM vm);

        [NonAction]
        public override System.Web.Mvc.ActionResult Prepare(Eumis.Portal.Web.Models.BFPContract.EditVM vm)
        {
        ...
        [NonAction]
        partial void EditPartialOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, System.Guid gid, string access_token);

        [NonAction]
        public override System.Web.Mvc.ActionResult EditPartial(System.Guid gid, string access_token)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.EditPartial);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "gid", gid);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "access_token", access_token);
            EditPartialOverride(callInfo, gid, access_token);
            return callInfo;
        }
