...
namespace Eumis.Portal.Web.Areas.Private.Controllers
{
    public partial class ProcurementsController
    {
        ...
        protected ProcurementsController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ProcurementsController Actions { get { return MVC.Private.Procurements; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Private";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Procurements";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Procurements";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Display = "~/Areas/Private/Views/Procurements/Display.cshtml";
            public readonly string Prepare = "~/Areas/Private/Views/Procurements/Prepare.cshtml";
            public readonly string Preview = "~/Areas/Private/Views/Procurements/Preview.cshtml";
            public readonly string Print = "~/Areas/Private/Views/Procurements/Print.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ProcurementsController : Eumis.Portal.Web.Areas.Private.Controllers.ProcurementsController
    {
        public T4MVC_ProcurementsController() : base(Dummy.Instance) { }

        [NonAction]
        partial void PrepareOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Eumis.Portal.Web.Models.Procurements.EditVM vm);

        [NonAction]
        public override System.Web.Mvc.ActionResult Prepare(Eumis.Portal.Web.Models.Procurements.EditVM vm)
        {
        ...
        [NonAction]
        partial void SaveOverride(T4MVC_System_Web_Mvc_ContentResult callInfo, Eumis.Portal.Web.Models.Procurements.EditVM model);

        [NonAction]
        public override System.Web.Mvc.ContentResult Save(Eumis.Portal.Web.Models.Procurements.EditVM model)
        {
