...
{
    public partial class TechnicalReportController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected TechnicalReportController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public TechnicalReportController Actions { get { return MVC.Report.TechnicalReport; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Report";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "TechnicalReport";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "TechnicalReport";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Display = "~/Areas/Report/Views/TechnicalReport/Display.cshtml";
            public readonly string Prepare = "~/Areas/Report/Views/TechnicalReport/Prepare.cshtml";
            public readonly string Preview = "~/Areas/Report/Views/TechnicalReport/Preview.cshtml";
            public readonly string Print = "~/Areas/Report/Views/TechnicalReport/Print.cshtml";
            public readonly string Upload = "~/Areas/Report/Views/TechnicalReport/Upload.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_TechnicalReportController : Eumis.Portal.Web.Areas.Report.Controllers.TechnicalReportController
    {
        public T4MVC_TechnicalReportController() : base(Dummy.Instance) { }

        [NonAction]
        partial void NewOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, System.Guid packageGid);

        [NonAction]
        public override System.Web.Mvc.ActionResult New(System.Guid packageGid)
        {
            ...
            NewOverride(callInfo, packageGid);
            return callInfo;
        }

        [NonAction]
        partial void PrepareOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Eumis.Portal.Web.Models.TechnicalReport.EditVM vm);

        [NonAction]
        public override System.Web.Mvc.ActionResult Prepare(Eumis.Portal.Web.Models.TechnicalReport.EditVM vm)
        {
        ...
        [NonAction]
        partial void SaveOverride(T4MVC_System_Web_Mvc_ContentResult callInfo, Eumis.Portal.Web.Models.TechnicalReport.EditVM model);

        [NonAction]
        public override System.Web.Mvc.ContentResult Save(Eumis.Portal.Web.Models.TechnicalReport.EditVM model)
        {
