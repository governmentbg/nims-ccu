...
namespace Eumis.Common.Extensions
{
    public class MimeTypeFileExtension
    {
        ...
        {
            Dictionary<string, string> extenstions =
                new Dictionary<string, string>();

            InitializeMimeTypeFileExtensionDictionary(extenstions);

            if (!extenstions.ContainsKey(extension))
                return string.Empty;

            return extenstions.FirstOrDefault(e => e.Key == extension).Value;
        }
