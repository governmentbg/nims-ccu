GO
--CompanySizeTypes
ALTER TABLE [dbo].[CompanySizeTypes] ADD [NameAlt] NVARCHAR(200) NULL;
GO

UPDATE [CompanySizeTypes] SET  
...
FROM (VALUES
    ...
    (3, 'Medium'),
    (4, 'Large'),
    (5, 'Not applicable')) AS ListData(CompanySizeTypeId, NameAlt) 
WHERE 
    ListData.CompanySizeTypeId = CompanySizeTypes.CompanySizeTypeId
GO

--CompanyTypes
ALTER TABLE [dbo].[CompanyTypes] ADD [NameAlt] NVARCHAR(200) NULL;
GO

UPDATE [CompanyTypes] SET  
    NameAlt = ListData.NameAlt
FROM (VALUES
    ...
    (5, 'Judiciary'),
    (6, 'Other'),
    (7, 'Medical establishment')) AS ListData(CompanyTypeId, NameAlt) 
WHERE 
    ListData.CompanyTypeId = CompanyTypes.CompanyTypeId
GO

--CompanyLegalTypes
ALTER TABLE [dbo].[CompanyLegalTypes] ADD [NameAlt] NVARCHAR(200) NULL;
GO

UPDATE [CompanyLegalTypes] SET  
    NameAlt = ListData.NameAlt
FROM (VALUES
    (1, 'Municipal administration'),
    (2, 'Regional administration'),
    (3, 'ACM/ ministry'),
    (4, 'Executive agency/ administrative structure established by legal act'),
    (5, 'State agency/ state commission'),
    (6, 'Others'),
    (7, 'Joint Stock company JSC (AD)'),
    (8, 'Single-member joint stock company SMJSC (EAD)'),
    (9, 'Limited liability company LLC (OOD)'),
    (10, 'Single-member limited liability company SMLLC (EOOD)'),
    (11, 'Sole Proprietor SP (ET)'),
    (12, 'Limited partnership LP (KD)'),
    (13, 'Limited partnership with a share capital LPSC (KDA)'),
    (14, 'General partnership GP (SD)'),
    (15, 'Others'),
    (16, 'Public benefit association'),
    (17, 'Private benefit association'),
    (18, 'Public benefit foundation'),
    (19, 'Private benefit foundation'),
    (20, 'Community center'),
    (21, 'Higher education establishment/ University'),
    (22, 'School'),
    (23, 'Kindergarten/ Nursery'),
    (24, 'Court'),
    (25, 'Investigation'),
    (26, 'Prosecution'),
    (29, 'Association of natural persons and/or legal entities'),
    (31, 'Natural person'),
    (33, 'Other legal entity'),
    (34, 'Hospital/ Medical establishment'),
    (35, 'Specialized territorial administration'),
    (36, 'Foreign'),
    (37, 'Supreme judicial court'),
    (38, 'SJCs Inspectorate')) AS ListData(CompanyLegalTypeId, NameAlt) 
WHERE 
    ListData.CompanyLegalTypeId = CompanyLegalTypes.CompanyLegalTypeId
GO

GO
ALTER TABLE [dbo].[KidCodes] ADD [NameAlt] NVARCHAR(200) NULL;
GO
...
FROM (VALUES
    ...
    ('13.95', 'Manufacture of non-wovens and articles made from nonwovens, except apparel'),
    ...
    ('18.13', 'Pre-press and premedia services'),
    ...
    ('85.41', 'Post-secondary nontertiary education'),
    ...
    ('99.00', 'Activities of extraterritorial organisations and bodies')) AS ListData(Code, NameAlt) 
WHERE 
    ListData.Code = KidCodes.Code
GO
