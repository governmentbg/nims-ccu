GO
ALTER TABLE [dbo].[Procedures] ADD [ProcedureContractReportDocumentsSectionStatus] INT NOT NULL CONSTRAINT DEFAULT_ProcedureContractReportDocumentsSectionStatus DEFAULT 1;

ALTER TABLE [dbo].[Procedures] DROP CONSTRAINT DEFAULT_ProcedureContractReportDocumentsSectionStatus;
GO

GO
ALTER TABLE [dbo].[Procedures] ADD CONSTRAINT [CHK_Procedures_ProcedureContractReportDocumentsSectionStatus] CHECK ([ProcedureContractReportDocumentsSectionStatus]   IN (1, 2));
GO
