...
<xsd:schema targetNamespace="http://ereg.egov.bg/segment/R-10019"
  ...
  <xsd:complexType name="Project">
    ...
    <xsd:sequence>
      ...
      <!-- ***** PRELIMINARY *****-->
      <xsd:element name="PreliminaryPartner" type="pp:PreliminaryPartner" minOccurs="0" />
      
      <xsd:element name="PreliminaryContract" type="pc:PreliminaryContract" minOccurs="0" />

      <xsd:element name="PreliminaryContractActivities" minOccurs="0">
        <xsd:complexType>
          <xsd:sequence>
            <xsd:element name="PreliminaryContractActivity" type="prca:PreliminaryContractActivity" minOccurs="0" maxOccurs="unbounded" />
          </xsd:sequence>
          <xsd:attribute name="id" type="xsd:string"/>
          <xsd:attribute name="isLocked" type="xsd:boolean"/>
        </xsd:complexType>
...
<xsd:schema targetNamespace="http://ereg.egov.bg/segment/R-10028" 
	xmlns="http://ereg.egov.bg/segment/R-10028" 
	
	xmlns:xsd="http://www.w3.org/2001/XMLSchema" 
	elementFormDefault="qualified">

	<xsd:complexType name="PreliminaryPartner">
		<xsd:annotation>
			<xsd:documentation xml:lang="bg">Партньор (за предварителен подбор)</xsd:documentation>
		</xsd:annotation>
		<xsd:sequence>
			<xsd:element name="ArePartnersIncluded" type="xsd:boolean" minOccurs="0" />
		</xsd:sequence>
...
<xsd:schema targetNamespace="http://ereg.egov.bg/segment/R-10029" 
	xmlns="http://ereg.egov.bg/segment/R-10029" 
	
	xmlns:xsd="http://www.w3.org/2001/XMLSchema" 
	elementFormDefault="qualified">

	<xsd:complexType name="PreliminaryContract">
		<xsd:annotation>
			<xsd:documentation xml:lang="bg">Източници на финансиране (за предварителен подбор)</xsd:documentation>
		</xsd:annotation>
		<xsd:sequence>
			<xsd:element name="RequestedFundingAmount" type="xsd:decimal" minOccurs="0" />
			<xsd:element name="CoFinancingBudgetAmount" type="xsd:decimal" minOccurs="0" />
      <xsd:element name="IsIncomeExpected" type="xsd:boolean" minOccurs="0" />
		</xsd:sequence>
...
<xsd:schema targetNamespace="http://ereg.egov.bg/segment/R-10030" 
	xmlns="http://ereg.egov.bg/segment/R-10030" 
	
	xmlns:xsd="http://www.w3.org/2001/XMLSchema" 
	elementFormDefault="qualified">

	<xsd:complexType name="PreliminaryContractActivity">
		<xsd:annotation>
			<xsd:documentation xml:lang="bg">План за изпълнение (за предварителен подбор)</xsd:documentation>
		</xsd:annotation>
		<xsd:sequence>
			<xsd:element name="Code" type="xsd:string" minOccurs="0" />
			<xsd:element name="Name" type="xsd:string" minOccurs="0" />
