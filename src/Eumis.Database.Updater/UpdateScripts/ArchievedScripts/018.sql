...
<xsd:schema targetNamespace="http://ereg.egov.bg/segment/R-10004" 
	...
	<xsd:complexType name="Company">
      ...
      <xsd:element name="FinancialContribution" type="xsd:string" minOccurs="0" />
...
<xsd:schema targetNamespace="http://ereg.egov.bg/segment/R-10006" 
	...
	<xsd:complexType name="Contract">
		...
		<xsd:sequence>
			<xsd:element name="RequestedFundingAmount" type="xsd:string" minOccurs="0" />
			<xsd:element name="RequestedFundingPartOfCrossFinancingAmount" type="xsd:string" minOccurs="0" />
      
			<xsd:element name="CoFinancingBudgetAmount" type="xsd:string" minOccurs="0" />
      <xsd:element name="BudgetEIBAmount" type="xsd:string" minOccurs="0" />
      <xsd:element name="BudgetEBRDAmount" type="xsd:string" minOccurs="0" />
      <xsd:element name="BudgetWBAmount" type="xsd:string" minOccurs="0" />
      <xsd:element name="BudgetOtherMFIAmount" type="xsd:string" minOccurs="0" />
      <xsd:element name="BudgetOtherAmount" type="xsd:string" minOccurs="0" />

      <xsd:element name="CoFinancingNonBudgetAmount" type="xsd:string" minOccurs="0" />
      <xsd:element name="NonBudgetEIBAmount" type="xsd:string" minOccurs="0" />
      <xsd:element name="NonBudgetEBRDAmount" type="xsd:string" minOccurs="0" />
      <xsd:element name="NonBudgetWBAmount" type="xsd:string" minOccurs="0" />
      <xsd:element name="NonBudgetOtherMFIAmount" type="xsd:string" minOccurs="0" />
      <xsd:element name="NonBudgetOtherAmount" type="xsd:string" minOccurs="0" />
      
      <xsd:element name="TotalCoFinancingAmount" type="xsd:string" minOccurs="0" />
			<xsd:element name="TotalEligibleCostsPublicFunding" type="xsd:string" minOccurs="0" />
			<xsd:element name="TotalEligibleCosts" type="xsd:string" minOccurs="0" />
			<xsd:element name="RatioRequestedFundingTotalEligibleCosts" type="xsd:string" minOccurs="0" />
			
			<xsd:element name="ExpectedRevenue" type="xsd:string" minOccurs="0" />
      
			<xsd:element name="IneligibleCosts" type="xsd:string" minOccurs="0" />
      <xsd:element name="IneligibleEIBAmount" type="xsd:string" minOccurs="0" />
      <xsd:element name="IneligibleEBRDAmount" type="xsd:string" minOccurs="0" />
      <xsd:element name="IneligibleWBAmount" type="xsd:string" minOccurs="0" />
      <xsd:element name="IneligibleOtherMFIAmount" type="xsd:string" minOccurs="0" />
      <xsd:element name="IneligibleOtherAmount" type="xsd:string" minOccurs="0" />
			
			<xsd:element name="TotalProjectCost" type="xsd:string" minOccurs="0" />
		</xsd:sequence>
	</xsd:complexType>
</xsd:schema>
...
<xsd:schema targetNamespace="http://ereg.egov.bg/segment/R-10007" 
	...
	<xsd:complexType name="ProgrammeDetailsExpenseBudget">
      ...
      <xsd:element name="NutsLevelId" type="xsd:string" minOccurs="0" />
      <xsd:element name="NutsAddressCode" type="xsd:string" minOccurs="0" />
      <xsd:element name="NutsAddressName" type="xsd:string" minOccurs="0" />
      <xsd:element name="NutsLocationFullPath" type="xsd:string" minOccurs="0" />
      ...
      <xsd:element name="EconomicDimensionCode" type="xsd:string" minOccurs="0" />
			<xsd:element name="GrandAmount" type="xsd:string" minOccurs="0" />
      <xsd:element name="SelfAmount" type="xsd:string" minOccurs="0" />
...
<xsd:schema targetNamespace="http://ereg.egov.bg/segment/R-10018" 
  ...
  <xsd:import namespace="http://ereg.egov.bg/segment/R-09992" />
	...
	<xsd:complexType name="AttachedDocument">
      ...
      <xsd:element name="SignatureContent" type="adc:AttachedDocumentContent" minOccurs="0" />
		</xsd:sequence>
	</xsd:complexType>
</xsd:schema>
