...
{
    internal class ContractReportFinancialCorrectionProcedureNomsRepository : EntityNomsRepository<Procedure, EntityNomVO>, IContractReportFinancialCorrectionProcedureNomsRepository
    {
        private IAccessContext accessContext;

        public ContractReportFinancialCorrectionProcedureNomsRepository(IUnitOfWork unitOfWork, IAccessContext accessContext)
            : base(
                unitOfWork,
                t => t.ProcedureId,
                t => t.Code + " " + t.Name,
