...
namespace Eumis.Data.Linq
{
    public static class ExpressionExtensions
    {
        ...
        public static Expression<Func<T, bool>> AndAnyStringContains<T>(this Expression<Func<T, bool>> expr, Expression<Func<T, string>> prop1, Expression<Func<T, string>> prop2, string value)
        {
            if (value == null)
            {
                return expr;
        ...
        public static Expression<Func<T, bool>> AndAnyStringContains<T>(this Expression<Func<T, bool>> expr, Expression<Func<T, string>> prop1, Expression<Func<T, string>> prop2, Expression<Func<T, string>> prop3, string value)
        {
            if (value == null)
            {
                return expr;
        ...
        public static Expression<Func<T, bool>> AndCollectionContains<T, TProp>(this Expression<Func<T, bool>> expr, Expression<Func<T, IEnumerable<TProp>>> prop, TProp value)
        {
            expr = expr.And(
                Expression.Lambda<Func<T, bool>>(
                    Expression.Call(
        ...
        private static Expression<Func<T, bool>> StringContainsExpression<T>(Expression<Func<T, string>> prop, string value)
        {
