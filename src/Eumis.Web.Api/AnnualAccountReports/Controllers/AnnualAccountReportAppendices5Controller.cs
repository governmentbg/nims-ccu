...
{
    [RoutePrefix("api/annualAccountReports/{annualAccountReportId}/appendices5")]
    public class AnnualAccountReportAppendices5Controller : ApiController
    {
        ...
        public AnnualAccountReportAppendices5Controller(
        ...
        [Route("")]
        public IList<AnnualAccountReportAppendixVO> GetAnnualAccountReportAppendices5(int annualAccountReportId)
        {
            this.authorizer.AssertCanDo(AnnualAccountReportActions.View, annualAccountReportId);

            return this.annualAccountReportsRepository.GetAnnualAccountReportAppendices(annualAccountReportId, AnnualAccountReportAppendixType.Appendix5);
        }

        [Route("{appendixId:int}")]
        public AnnualAccountReportAppendixDO GetAnnualAccountReportAppendix5(int annualAccountReportId, int appendixId)
        {
        ...
        [Route("{appendixId:int}")]
        [Transaction]
        [ActionLog(Action = typeof(ActionLogGroups.AnnualAccountReports.Edit.Appendices5.Edit), IdParam = "annualAccountReportId", ChildIdParam = "appendixId")]
        public void UpdateAnnualAccountReportAppendix5(int annualAccountReportId, int appendixId, AnnualAccountReportAppendixDO appendix)
        {
            this.authorizer.AssertCanDo(AnnualAccountReportActions.Edit, annualAccountReportId);
