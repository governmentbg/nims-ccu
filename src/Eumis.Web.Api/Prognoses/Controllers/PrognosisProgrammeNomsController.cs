...
{
    [RoutePrefix("api/nomenclatures/prognosisProgrammes")]
    public class PrognosisProgrammeNomsController : ApiController
    {
        private IProgrammeNomsRepository programmeNomsRepository;
        private IAccessContext accessContext;
        private IPermissionsRepository permissionsRepository;

        public PrognosisProgrammeNomsController(
        ...
        [Route("")]
        public IEnumerable<EntityNomVO> GetNoms(int? procedureId = null, string term = null, int offset = 0, int? limit = null, bool readOnly = false)
        {
