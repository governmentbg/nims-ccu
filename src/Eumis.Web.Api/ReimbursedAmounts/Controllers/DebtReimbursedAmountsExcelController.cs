...
{
    public class DebtReimbursedAmountsExcelController : ApiController
    {
        ...
        public DebtReimbursedAmountsExcelController(
        ...
        [Route("api/debtReimbursedAmounts/excelExport")]
        public HttpResponseMessage GetDebtReimbursedAmounts(int? contractId = null, ReimbursementType? type = null)
        {
            ...
            var reimbursedAmounts = this.debtReimbursedAmountsRepository.GetReimbursedAmounts(programmeIds, this.accessContext.UserId, contractId, type);
            var workbook = this.GetWorkbook(reimbursedAmounts);

            return this.Request.CreateXmlResponse(workbook, "debtReimbursedAmounts");
        }

        private XLWorkbook GetWorkbook(IList<DebtReimbursedAmountVO> reimbursedAmounts)
        {
            ...
            foreach (var reimbursedAmount in reimbursedAmounts)
            {
                ...
                ws.Cell(rowIndex, "B").Value = reimbursedAmount.DebtRegNumber;
