...
{
    [RoutePrefix("api/nomenclatures/notificationSettingProgrammes")]
    public class NotificationSettingProgrammesNomsController : ApiController
    {
        private IProgrammeNomsRepository programmeNomsRepository;
        private IAccessContext accessContext;
        private IPermissionsRepository permissionsRepository;

        public NotificationSettingProgrammesNomsController(
        ...
        {
            var programmeIds = this.permissionsRepository.GetProgrammeIdsByPermission(this.accessContext.UserId, OperationalMapPermissions.CanRead);
