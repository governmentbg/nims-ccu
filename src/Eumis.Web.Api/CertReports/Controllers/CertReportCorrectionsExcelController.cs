...
{
    public class CertReportCorrectionsExcelController : ApiController
    {
        ...
        public CertReportCorrectionsExcelController(
        ...
        [Route("api/certReports/{certReportId:int}/corrections/excelExport")]
        public HttpResponseMessage GetCertReportCorrections(int certReportId)
        {
        ...
        private XLWorkbook GetWorkbook(IList<CertReportCorrectionVO> certReportCorrections)
        {
