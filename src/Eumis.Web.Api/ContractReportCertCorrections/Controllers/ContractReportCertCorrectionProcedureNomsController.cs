...
{
    [RoutePrefix("api/nomenclatures/contractReportCertCorrectionProcedures")]
    public class ContractReportCertCorrectionProcedureNomsController : ApiController
    {
        private IPermissionsRepository permissionsRepository;
        private IAccessContext accessContext;
        private IProcedureNomsRepository procedureNomsRepository;

        public ContractReportCertCorrectionProcedureNomsController(
