...
{
    [RoutePrefix("api/nomenclatures/actuallyPaidAmountProgrammes")]
    public class ActuallyPaidAmountProgrammeNomsController : ApiController
    {
        private IProgrammeNomsRepository programmeNomsRepository;
        private IAccessContext accessContext;
        private IPermissionsRepository permissionsRepository;

        public ActuallyPaidAmountProgrammeNomsController(
