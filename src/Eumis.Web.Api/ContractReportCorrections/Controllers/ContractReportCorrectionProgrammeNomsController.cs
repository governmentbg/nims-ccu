...
{
    [RoutePrefix("api/nomenclatures/contractReportCorrectionProgrammes")]
    public class ContractReportCorrectionProgrammeNomsController : ApiController
    {
        private IProgrammeNomsRepository programmeNomsRepository;
        private IAccessContext accessContext;
        private IPermissionsRepository permissionsRepository;

        public ContractReportCorrectionProgrammeNomsController(
