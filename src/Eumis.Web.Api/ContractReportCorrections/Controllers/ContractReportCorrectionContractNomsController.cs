...
{
    [RoutePrefix("api/nomenclatures/contractReportCorrectionContracts")]
    public class ContractReportCorrectionContractNomsController : ApiController
    {
        private IContractNomsRepository contractNomsRepository;
        private IAccessContext accessContext;
        private IPermissionsRepository permissionsRepository;

        public ContractReportCorrectionContractNomsController(
        ...
        public IEnumerable<EntityNomVO> GetNoms(string term = null, int offset = 0, int? limit = null)
        {
            ...
            return this.contractNomsRepository.GetContracts(term, offset, limit, programmeIds, this.accessContext.UserId);
        }
    }
}
