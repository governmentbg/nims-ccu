...
{
    [RoutePrefix("api/nomenclatures/contractReportCorrectionProcedures")]
    public class ContractReportCorrectionProcedureNomsController : ApiController
    {
        private IPermissionsRepository permissionsRepository;
        private IAccessContext accessContext;
        private IProcedureNomsRepository procedureNomsRepository;

        public ContractReportCorrectionProcedureNomsController(
