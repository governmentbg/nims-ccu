...
{
    [RoutePrefix("api/nomenclatures/contractReportRevalidationCertAuthorityCorrectionContracts")]
    public class ContractReportRevalidationCertAuthorityCorrectionContractNomsController : ApiController
    {
        private IContractNomsRepository contractNomsRepository;
        private IAccessContext accessContext;
        private IPermissionsRepository permissionsRepository;

        public ContractReportRevalidationCertAuthorityCorrectionContractNomsController(
