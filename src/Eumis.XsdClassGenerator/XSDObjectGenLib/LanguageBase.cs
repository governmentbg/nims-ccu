...
namespace Eumis.XsdClassGenerator.XSDObjectGenLib
{
    internal abstract class LanguageBase
    {
        ...
        protected virtual string CalculateNamespace(string schemaNamespace, string importedNamespace, bool any)
        {
            ...
            return (",Namespace" + this.AttributeAssignmentOperator + "\"" + schemaNamespace + "\"");
        }
        ...
        public abstract void NamespaceHeaderCode(StreamWriter outStream, string ns, string schemaFile, Hashtable forwardDeclarations, string targetNamespace, bool depthFirstTraversalHooks, ArrayList importedReferences);
        public abstract void Enumerations(StreamWriter outStream, Hashtable enumerations);
