...
{
    public partial class ContractReportCertCorrection : IAggregateRoot
    {
        public ContractReportCertCorrection()
        {
            this.Documents = new List<ContractReportCertCorrectionDocument>();
        }
            ...
            int? contractReportPaymentId)
        {
            ...
            switch (type)
            {
                case ContractReportCertCorrectionType.PaymentCertified:
                    ...
                    {
                        throw new DomainValidationException(string.Format("ProcedureId, ContractId and ContractReportPaymentId are required for ContractReportCertCorrection with type {0}", type));
                    }
                ...
                case ContractReportCertCorrectionType.ContractCertified:
                    ...
                    {
                        throw new DomainValidationException(string.Format("ProcedureId, ContractId are required for ContractReportCertCorrection with type {0}", type));
                    }
                ...
                case ContractReportCertCorrectionType.ProgramePriorityCertified:
                    ...
                    {
                        throw new DomainValidationException(string.Format("ProgrammePriorityId is required for ContractReportCertCorrection with type {0}", type));
                    }
                ...
                case ContractReportCertCorrectionType.ProcedureCertified:
                    ...
                    {
                        throw new DomainValidationException(string.Format("ProcedureId is required for ContractReportCertCorrection with type {0}", type));
                    }
        ...
        public ICollection<ContractReportCertCorrectionDocument> Documents { get; set; }
    }

    [System.Diagnostics.CodeAnalysis.SuppressMessage("", "SA1402:FileMayOnlyContainASingleType", Justification = "Map classes should be in the same file for simplicity")]
    public class ContractReportCertCorrectionMap : EntityTypeConfiguration<ContractReportCertCorrection>
    {
        public ContractReportCertCorrectionMap()
        {
            // Primary Key
            this.HasKey(t => t.ContractReportCertCorrectionId);
            ...
            this.ToTable("ContractReportCertCorrections");
