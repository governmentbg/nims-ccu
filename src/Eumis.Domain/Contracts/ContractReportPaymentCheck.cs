...
namespace Eumis.Domain.Contracts
{
    ...
    {
        private ContractReportPaymentCheck()
        {
            this.ContractReportPaymentCheckAmounts = new List<ContractReportPaymentCheckAmount>();
        }

        public ContractReportPaymentCheck(
            ...
            : this()
        {
            ...
            this.Status = ContractReportPaymentCheckStatus.Draft;
