    ...
    public partial class ContractReportIndicator : IAggregateRoot
    {
            ...
            string comment)
        {
            ...
            this.ValidateAmounts(
                this.PeriodAmountMen,
                this.PeriodAmountWomen,
                this.PeriodAmountTotal,
                this.CumulativeAmountMen,
                this.CumulativeAmountWomen,
                this.CumulativeAmountTotal,
                this.ResidueAmountMen,
                this.ResidueAmountWomen,
                this.ResidueAmountTotal,
                this.LastReportCumulativeAmountMen,
                this.LastReportCumulativeAmountWomen,
                this.LastReportCumulativeAmountTotal,
                "Reported",
                contractIndicator);
        }
