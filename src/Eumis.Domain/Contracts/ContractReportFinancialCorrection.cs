...
{
    public partial class ContractReportFinancialCorrection : IAggregateRoot
    {
        private ContractReportFinancialCorrection()
        {
        }

        public ContractReportFinancialCorrection(
            ...
            int orderNum)
        {
            ...
            this.Status = ContractReportFinancialCorrectionStatus.Draft;
    ...
    public class ContractReportFinancialCorrectionMap : EntityTypeConfiguration<ContractReportFinancialCorrection>
    {
        public ContractReportFinancialCorrectionMap()
        {
            // Primary Key
            this.HasKey(t => t.ContractReportFinancialCorrectionId);
            ...
            this.ToTable("ContractReportFinancialCorrections");
