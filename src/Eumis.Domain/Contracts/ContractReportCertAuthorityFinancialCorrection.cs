...
{
    public partial class ContractReportCertAuthorityFinancialCorrection : IAggregateRoot
    {
        private ContractReportCertAuthorityFinancialCorrection()
        {
        }

        public ContractReportCertAuthorityFinancialCorrection(
            ...
            int orderNum)
        {
            ...
            this.Status = ContractReportCertAuthorityFinancialCorrectionStatus.Draft;
    ...
    public class ContractReportCertAuthorityFinancialCorrectionMap : EntityTypeConfiguration<ContractReportCertAuthorityFinancialCorrection>
    {
        public ContractReportCertAuthorityFinancialCorrectionMap()
        {
            // Primary Key
            this.HasKey(t => t.ContractReportCertAuthorityFinancialCorrectionId);
            ...
            this.ToTable("ContractReportCertAuthorityFinancialCorrections");
