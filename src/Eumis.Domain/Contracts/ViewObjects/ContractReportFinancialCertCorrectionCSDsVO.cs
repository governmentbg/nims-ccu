...
{
    public class ContractReportFinancialCertCorrectionCSDsVO
    {
        ...
        public ContractReportFinancialCertCorrectionCSDDO ContractReportFinancialCertCorrectionCSD { get; set; }
    }
}
