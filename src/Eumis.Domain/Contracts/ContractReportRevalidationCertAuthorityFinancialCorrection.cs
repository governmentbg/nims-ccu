...
{
    public partial class ContractReportRevalidationCertAuthorityFinancialCorrection : IAggregateRoot
    {
        private ContractReportRevalidationCertAuthorityFinancialCorrection()
        {
        }

        public ContractReportRevalidationCertAuthorityFinancialCorrection(
            ...
            int orderNum)
        {
            ...
            this.Status = ContractReportRevalidationCertAuthorityFinancialCorrectionStatus.Draft;
    ...
    public class ContractReportRevalidationCertAuthorityFinancialCorrectionMap : EntityTypeConfiguration<ContractReportRevalidationCertAuthorityFinancialCorrection>
    {
        public ContractReportRevalidationCertAuthorityFinancialCorrectionMap()
        {
            // Primary Key
            this.HasKey(t => t.ContractReportRevalidationCertAuthorityFinancialCorrectionId);
            ...
            this.ToTable("ContractReportRevalidationCertAuthorityFinancialCorrections");
