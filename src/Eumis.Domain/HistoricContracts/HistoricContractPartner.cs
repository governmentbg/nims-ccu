...
namespace Eumis.Domain.HistoricContracts
{
    public class HistoricContractPartner
    {
        ...
        private HistoricContractPartner()
        {
        }

        public HistoricContractPartner(
            int historicContractId,
            HistoricContractPartnerType partnerType,
            string partnerName,
            string partnerNameEn,
            string partnerUin,
            UinType partnerUinType,
            int partnerTypeId,
            ...
            string seatAddress)
        {
            this.HistoricContractPartnerId = historicContractActivitySequence.NextIntValue();
            this.HistoricContractId = historicContractId;
            this.PartnerType = partnerType;
            this.PartnerName = partnerName;
            this.PartnerNameEn = partnerNameEn;
            this.PartnerUin = partnerUin;
            this.PartnerUinType = partnerUinType;
            this.PartnerTypeId = partnerTypeId;
            this.PartnerLegalTypeId = partnerLegalTypeId;
