...
namespace Eumis.Domain.Companies
{
    ...
    {
        private static Sequence companySequence = new Sequence("CompanySequence", "DbContext");

        private Company()
        {
            this.LocalActionGroupMunicipalities = new List<LocalActionGroupMunicipality>();
        }
        ...
        public Company(
            ...
            : this()
        {
            // used to handle RegiX result (read only)
            this.Uin = uin;
        ...
        public Company(
            ...
            : this()
        {
            this.CompanyId = companySequence.NextIntValue();
        ...
        public virtual ICollection<LocalActionGroupMunicipality> LocalActionGroupMunicipalities { get; set; }
    }
    ...
    public class CompanyMap : EntityTypeConfiguration<Company>
    {
        public CompanyMap()
        {
            ...
            this.Property(t => t.ProgrammePriorityType).HasColumnName("ProgrammePriorityType");
