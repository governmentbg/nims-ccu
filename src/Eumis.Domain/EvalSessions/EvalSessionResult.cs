...
namespace Eumis.Domain.EvalSessions
{
    public class EvalSessionResult
    {
        ...
        public EvalSessionResult(int procedureId, EvalSessionResultType type)
            : this()
        {
    ...
    public class EvalSessionAdminAdmissResultMap : EntityTypeConfiguration<EvalSessionResult>
    {
        public EvalSessionAdminAdmissResultMap()
        {
            ...
            this.HasRequired(t => t.EvalSession)
                .WithMany(t => t.EvalSessionResults)
                .HasForeignKey(t => t.EvalSessionId);

            this.HasOptional(t => t.PublicationUser)
                .WithMany()
                .HasForeignKey(t => t.PublicationUserId);
        }
    }
}
