...
{
    public partial class SapDistributedLimit
    {
        ...
        public static readonly IList<SapDistributedLimitEuFund> BgAmountsFunds = new List<SapDistributedLimitEuFund>
        {
            SapDistributedLimitEuFund.AdvanceBg,
            SapDistributedLimitEuFund.FinalBg,
            SapDistributedLimitEuFund.InterimBg,
        };

        public static readonly IList<SapDistributedLimitEuFund> EuAmountsFunds = new List<SapDistributedLimitEuFund>
        {
            SapDistributedLimitEuFund.AdvanceEu,
            SapDistributedLimitEuFund.FinalEu,
            SapDistributedLimitEuFund.InterimEu,
        };
    ...
    public class SapDistributedLimitMap : EntityTypeConfiguration<SapDistributedLimit>
    {
        public SapDistributedLimitMap()
        {
            // Primary Key
            this.HasKey(t => t.SapDistributedLimitId);

            // Properties
            this.Property(t => t.SapDistributedLimitId)
            ...
            this.ToTable("SapDistributedLimits");
            this.Property(t => t.SapDistributedLimitId).HasColumnName("SapDistributedLimitId");
