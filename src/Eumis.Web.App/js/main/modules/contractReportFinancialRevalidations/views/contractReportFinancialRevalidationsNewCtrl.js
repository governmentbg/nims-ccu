...
function ContractReportFinancialRevalidationsNewCtrl(
  $q,
  $scope,
  $state,
  $stateParams,
  ...
  $scope.save = function() {
    return $scope.newContractReportFinancialRevalidationsForm.$validate().then(function() {
      if ($scope.newContractReportFinancialRevalidationsForm.$valid) {
        return scConfirm({
          ...
          if (result.executed) {
            return ContractReportFinancialRevalidation.save(
              {
                contractNum: $scope.model.contractNumber,
                contractReportNum: $scope.model.contractReportNum
              },
              ...
              return $state.go('root.contractReportFinancialRevalidations.view.contract', {
                id: result.contractReportFinancialRevalidationId
              });
            });
          }
        });
  ...
  $scope.chooseContractReport = function() {
    var modalInstance = scModal.open('chooseCRFRContractReportModal', {
...
ContractReportFinancialRevalidationsNewCtrl.$inject = [
  '$q',
  '$scope',
  '$state',
  '$stateParams',
...
export { ContractReportFinancialRevalidationsNewCtrl };
