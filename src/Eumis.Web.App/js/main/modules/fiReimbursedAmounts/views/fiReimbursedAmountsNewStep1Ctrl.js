...
function FIReimbursedAmountsNewStep1Ctrl($q, $scope, $state, scModal, scConfirm, Contract) {
  $scope.model = {};

  $scope.next = function() {
    return $scope.reimbursedAmountsNewStep1Form.$validate().then(function() {
      if ($scope.reimbursedAmountsNewStep1Form.$valid) {
        return $state.go('root.fiReimbursedAmounts.newStep2', {
...
FIReimbursedAmountsNewStep1Ctrl.$inject = [
  '$q',
  '$scope',
  '$state',
  'scModal',
...
export { FIReimbursedAmountsNewStep1Ctrl };
