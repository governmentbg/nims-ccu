PRINT 'Create View [MonitoringMapNodeIndicator]'
GO

IF EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'vwMonitoringMapNodeIndicators'))
DROP VIEW vwMonitoringIndicators
GO
