...
namespace NCalc.Tests
{
    ...
    public class Fixtures
    {
        ...
        public void ShouldEvaluateConditionnal()
        {
            ...
            Assert.AreEqual(1M, eif.Evaluate());
        ...
        public void ShouldHandleOperatorsPriority()
        {
            ...
            Assert.AreEqual(9M, new Expression("1 + 2 + 3 * 4 / 2").Evaluate());
            Assert.AreEqual(13.5M, new Expression("18/2/2*3").Evaluate());
        }

        [TestMethod]
        public void ShouldNotLoosePrecision()
        {
            Assert.AreEqual(0.5M, new Expression("3/6").Evaluate());
        }
        ...
        {
            Assert.AreEqual(1M, new Expression("aBs(-1)", EvaluateOptions.IgnoreParametersAndFunctionsCase).Evaluate());
        ...
        {
            Assert.AreEqual(12.2M, new Expression("1.22e1").Evaluate());
            Assert.AreEqual(100M, new Expression("1e2").Evaluate());
            Assert.AreEqual(100M, new Expression("1e+2").Evaluate());
            Assert.AreEqual(0.01M, new Expression("1e-2").Evaluate());
            Assert.AreEqual(0.001M, new Expression(".1e-2").Evaluate());
            Assert.AreEqual(10000000000M, new Expression("1e10").Evaluate());
        }
