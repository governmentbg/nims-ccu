...
namespace NCalc.Domain
{
    ...
    public class EvaluationVisitor : LogicalExpressionVisitor
    {
        ...
        private bool IgnoreParametersAndFunctionsCase { get { return (_options & EvaluateOptions.IgnoreParametersAndFunctionsCase) == EvaluateOptions.IgnoreParametersAndFunctionsCase; } }

        private bool IgnoreCaseWhenCompareStrings { get { return (_options & EvaluateOptions.IgnoreCaseWhenCompareStrings) == EvaluateOptions.IgnoreCaseWhenCompareStrings; } }
    ...
    /// <summary>
        ...
        public int CompareUsingMostPreciseType(object a, object b)
        {
            ...
            Type mpt = GetMostPreciseType(aType, bType);

            if (IgnoreCaseWhenCompareStrings && aType == typeof(String) && bType == typeof(String))
            {
        ...
        public override void Visit(Function function)
        {
            ...
            OnEvaluateFunction(IgnoreParametersAndFunctionsCase ? function.Identifier.Name.ToLower() : function.Identifier.Name, args);
        ...
        {
            if (IgnoreParametersAndFunctionsCase)
            {
