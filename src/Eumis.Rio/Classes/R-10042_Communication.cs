...
namespace Eumis.Rio
{
	...
	[XmlType(TypeName="Communication",Namespace="http://ereg.egov.bg/segment/R-10042"),Serializable]
	...
	public partial class Communication
	{
		...
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public Eumis.Rio.CommunicationTypeNomenclature __type;
		...
		[XmlIgnore]
		public Eumis.Rio.CommunicationTypeNomenclature type
		{ 
			get { return __type; }
			set { __type = value; __typeSpecified = true; }
		}

		[XmlElement(ElementName="Subject",IsNullable=false,Form=XmlSchemaForm.Qualified,DataType="string",Namespace="http://ereg.egov.bg/segment/R-10042")]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		...
		[XmlElement(ElementName="Content",IsNullable=false,Form=XmlSchemaForm.Qualified,DataType="string",Namespace="http://ereg.egov.bg/segment/R-10042")]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		...
		[XmlElement(Type=typeof(Eumis.Rio.AttachedDocument),ElementName="AttachedDocument",IsNullable=false,Form=XmlSchemaForm.Qualified,Namespace="http://ereg.egov.bg/segment/R-10042")]
		[EditorBrowsable(EditorBrowsableState.Advanced)]
