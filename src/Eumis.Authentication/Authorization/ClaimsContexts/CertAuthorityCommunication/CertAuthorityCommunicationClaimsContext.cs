...
{
    internal class CertAuthorityCommunicationClaimsContext : ClaimsContext, ICertAuthorityCommunicationClaimsContext
    {
        ...
        public CertAuthorityCommunicationClaimsContext(
            int communicationId,
            [KeyFilter(ClaimsCaches.CertAuthorityCommunication)]IClaimsCache claimsCache,
