...
@"	using {1}{2} = System.Collections.Generic.List<{0}>;";
...
@"		[XmlText(DataType=""{1}"")]
        ...
        public override void NamespaceHeaderCode(StreamWriter outStream, string ns, string schemaFile, Hashtable forwardDeclarations, string targetNamespace, bool depthFirstTraversalHooks, ArrayList importedReferences)
        {
        ...
        public override void Enumerations(StreamWriter outStream, Hashtable enumerations)
        {
